    ...
    try {
      ...
      if (user == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Veuillez vous connecter pour ajouter un article au panier.'),
      ...
      if (item['title'] == null || item['size'] == null || item['price'] == null || item['image'] == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Marque
            Text(
              'Marque : ${item['marque'] ?? 'Inconnue'}',
              style: const TextStyle(fontSize: 18),
            ),

            // Prix
            Text(
              'Prix : ${double.tryParse(item['price'].toString())?.toStringAsFixed(2) ?? '0.00'} €', 
              style: const TextStyle(fontSize: 18),
            ),
